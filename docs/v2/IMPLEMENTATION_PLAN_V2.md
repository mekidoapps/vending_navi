...
- [x] P3-03 現在地Service／Controller
- [x] P3-04 全面HomeMapScreen
- [x] P3-05 周辺自販機・状態ピン
- [x] P3-06 固定吹き出し・詳細
- [x] P3-07 外部経路・Phase 3品質ゲート
...
- [x] P4-03 `machine_product_index` read
- [x] P4-04 Product検索結果・選択ラベル・検索解除
- [x] P4-05 ジャンル検索
- [x] P4-06 よく飲む商品表示領域
- [x] P4-07 検索対象の固定カード・詳細優先表示
- [x] P4-08 Phase 4品質ゲート

**完了:** Product・Genre検索がHomeMap・固定カード・詳細まで成立し、Phase 4品質ゲートを通過する。
...
**完了:** 必須15シナリオ、Responsive、Pixel 6a実機、AI実写真、全体回帰を完了し、P0/P1が0件であることを確認。
...
> Phase 5詳細: `PHASE5_AUTH_USER_PLAN_V2.md`

...
class V2MachineProductPicker extends ConsumerStatefulWidget {
  const V2MachineProductPicker({
    super.key,
  ...
  static Future<Product?> show(
    ...
    return showModalBottomSheet<Product>(
      ...
      useSafeArea: true,
      builder: (_) {
        return V2MachineProductPicker(existingProductIds: existingProductIds);
      },
    );
  }

  @override
  ConsumerState<V2MachineProductPicker> createState() =>
      _V2MachineProductPickerState();
}

class _V2MachineProductPickerState
    extends ConsumerState<V2MachineProductPicker> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              key: const Key('machineProductPickerSearchField'),
  ...
  Widget _buildBody() {
    ...
    return ListView.separated(
      key: const Key('machineProductPickerResults'),
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          key: Key('machineProductPicker_${product.id.value}'),
